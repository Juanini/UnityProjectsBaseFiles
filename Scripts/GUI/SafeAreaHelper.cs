...
public class SafeAreaHelper : MonoBehaviour
{
    ...
    public List<RectTransform> safeAreaTransformList;
    ...
    void ApplySafeArea()
    {
        ...
        for (int i = 0; i < safeAreaTransformList.Count; i++)
        {
            safeAreaTransformList[i].anchorMin = anchorMin;
            safeAreaTransformList[i].anchorMax = anchorMax;
        }
    }
